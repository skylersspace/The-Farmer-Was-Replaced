...
def move_list(coord, direction):
	# North 0, East 1, South 2, West 3
	if (direction == 0):
		#quick_print("North", (coord[0] + 0, coord[1] + 1))
		return ((coord[0], coord[1] + 1))
	elif (direction == 1):
		#quick_print("East", (coord[0] + 1, coord[1] + 0))
		return ((coord[0] + 1, coord[1]))
	elif (direction == 2):
		#quick_print("South", (coord[0] + 0, coord[1] - 1))
		return ((coord[0], coord[1] -1))
	else:
		#quick_print("West", (coord[0] - 1, coord[1] + 0))
		return ((coord[0] - 1, coord[1]))
...
def random_list(size, max_value):
	return_array = []
	for i in range(size):
		return_array.append(random() * max_value // 1)
	return return_array
...
#TO DO -- Quick Sort, Selection Sort, Insertion Sort, Gnome Sort, Shaker Sort
